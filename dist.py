...
if __name__ == '__main__':
    ...
    for class_name in sorted(glob.glob('{}/{}/train/sketch/*'.format(data_root, data_name))):
        ...
        selected = random.choices(olds, k=num_sample)
        old_paths += selected
        new_paths += [image.replace('_real.png', '_fake.png') for image in selected]
    ...
    sns.set()
    data = {'w/o synthesis': op_distance, 'w/ synthesis': np_distance}
